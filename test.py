...
from miniNN import Relu, Tanh, Linear, MSELoss, Sequential
...
def train_model(model, train_input, train_target, test_input, test_target, nb_epochs, lr, mini_batch_size):
    ...
    for m in range(nb_epochs):
        ...
        print('{}/{}: train_loss: {:.04f} train_error {:.02f}% test_error {:.02f}%'.format(m,
...
if __name__ == "__main__":
    ...
    train_input, train_target, test_input, test_target = split_data(data, target, 0.8)
